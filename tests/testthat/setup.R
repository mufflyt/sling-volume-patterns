...
source(file.path(.proj_root, "R", "classification_schemes.R"))
source(file.path(.proj_root, "R", "workforce_dynamics.R"))
source(file.path(.proj_root, "R", "build_ffs_denominator.R"))
source(file.path(.proj_root, "R", "specialty_groups.R"))
source(file.path(.proj_root, "R", "manuscript_sections.R"))
setwd(.old_wd)
rm(.proj_root, .old_wd)
