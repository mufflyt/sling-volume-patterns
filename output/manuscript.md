# Specialty Distribution, Procedural Concentration, and Trends in Midurethral Sling Surgery Among Medicare Beneficiaries, 2013–2023
...
To estimate market-share trends, we separately regressed each specialty's annual percentage share on calendar year using ordinary least squares. We modeled URPS, urology, General OB/GYN, and the combined gynecologic share; MIGS was described without formal emphasis because only 10 physicians were identified.
...
| **Total** | **1,745** | **6,202** | **131,637** | **100%** | n/a | n/a | n/a | n/a | n/a |

\*MIGS estimates are descriptive because only 10 physicians were identified.
...
|----------|:-----------:|:---------------:|:-------:|
| Fixed membership: gynecologic share (ABOG-URPS + MIGS + Gen OB/GYN) | 60.8% → 70.1% | 0.84 | <0.001 |
| Fixed membership: combined-URPS share | 53.4% → 63.8% | 0.90 | <0.001 |
| Modal: URPS share | n/a | 0.98 | <0.001 |
| Ever-URPS/MIGS: URPS share | n/a | 0.96 | 0.001 |
| **Certification-gated: URPS share (time-varying)** | **42.2% → 62.8%** | **1.54** | **<0.001** |
| Certification-gated: gynecologic share (time-varying) | n/a | 0.55 | 0.009 |
...
|:----:|:----------:|:--------:|:----------:|:-------:|:--------------------:|:---------------------:|
| 2013 | 812 | n/a | n/a | 214 | n/a | n/a |
| 2014 | 685 | n/a | n/a | 164 | n/a | n/a |
...
**Figure 3.** Lorenz curves of procedural concentration by specialty. Greater distance from the diagonal indicates greater concentration. URPS (Gini 0.51) is closest to equality; MIGS (0.60) is farthest.
